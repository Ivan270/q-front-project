...
/**
  ...
  *
  * @checksum - ed1b73818d95cfc5707e96e0bbff753efc49cceed7ea49da7e919a19b3bc308a
  * @variables - radius=rounded,accentColor=blue,colorTemperature=slate,spacing=2.5,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=100,borderShadeDarkMode=400,inputMaxWidth=max-w-none,tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:dropdown__listbox": {
    ...
    "group-data-[overscroll]:dark:border-slate-500": true
  },
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-slate-100": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-slate-100": true,
    "dark:group-data-[prefix-icon]:border-slate-400": true,
    "dark:group-data-[suffix-icon]:border-slate-400": true
  },
  "color__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "dark:[&::-webkit-slider-runnable-track]:bg-slate-400/50": true,
    ...
    "dark:[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-slate-500": true,
    ...
    "dark:[&::-moz-range-track]:bg-slate-400/50": true,
  ...
  "submit__input": {
    ...
    "disabled:border-slate-100": true,
  ...
  "autocomplete__selectionWrapper": {
    ...
    "dark:group-data-[multiple]:border-slate-400": true,
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-slate-100": true,
    "dark:[&>div>div::after]:bg-slate-400": true
  },
  "slider__maxValue": {
    "grow": true,
    "!max-w-[45%]": true,
  ...
  "multi-step__tabs": {
    ...
    "group-data-[tab-style=\"tab\"]/wrapper:border-slate-100": true,
    ...
    "dark:group-data-[tab-style=\"tab\"]/wrapper:border-slate-500": true,
  ...
  "multi-step__tab": {
    ...
    "dark:group-data-[tab-style=\"progress\"]/wrapper:before:border-slate-500": true,
    ...
    "dark:group-data-[tab-style=\"progress\"]/wrapper:after:bg-slate-500": true,
